...
public class SampleController {
	...
	public @ResponseBody String getStorageCount() {
		...
		int threadBeanCount = ManagementFactory.getThreadMXBean().getThreadCount();

		int stackThreadCount = 0;
		...
		return "queueCount : " + queueCount + " // mapCount : " + mapCount + "// Thread Count : " + Thread.activeCount()
				+ "// Thread group Count : " + Thread.currentThread().getThreadGroup() + "// Thread bean Count : "
				+ threadBeanCount + "// stack Count : " + stackThreadCount;
	}
}
